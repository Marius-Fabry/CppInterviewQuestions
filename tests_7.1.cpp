...
class Problem7_1 {
public:
    static void Problem7_1::run_tests()
    {
    ...
    static void Problem7_1::test_positive_number_int_to_string()
    {
        TEST_ASSERT_EQUAL(integer_to_string(123), "123");
    }

    static void Problem7_1::test_negative_number_int_to_string()
    {
        TEST_ASSERT_EQUAL(integer_to_string(-11), "-11");
    }

    static void Problem7_1::test_positive_number_string_to_int()
    {
        TEST_ASSERT_EQUAL(string_to_integer("123"), 123);
    }

    static void Problem7_1::test_negative_number_string_to_int()
    {
